...
- **731 driver files** = 707 carrying coverage + 24 pulled in only to close clone→parent links
- **1903 parent romsets** of coverage value
- of the 707 coverage files, **7** need `drcbearm32` (SH-2/SH-3)
- **181** of them have a mame4all fallback if lrmame cannot hold 60 Hz; the other **526** do not
