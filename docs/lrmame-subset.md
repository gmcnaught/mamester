...
- **974 driver files** = 728 carrying coverage + 24 pulled in only to close clone→parent links + 222 sibling implementation files that `#include` following does not reach
